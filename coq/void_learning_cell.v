(******************************************************************************)
(* void_learning_cell.v - THRESHOLD CELL                                     *)
(*                                                                          *)
(* One of two cell models in VOID. This one fires when input >= threshold.  *)
(* Learning adjusts the threshold via erode (lower) and constrict (raise).  *)
(* Weights are external (see WeightedCell in void_network.v).               *)
(*                                                                          *)
(* The other model: void_predictive_cell.v (dual accumulator, no threshold).*)

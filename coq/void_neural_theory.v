(******************************************************************************)
(* void_neural_theory.v - REFUND, INTERFERENCE, VERDICT                      *)
(*                                                                          *)
(* Three mechanisms for any VOID network, regardless of cell model:         *)
(*                                                                          *)
(* 1. REFUND - budget flows back to cells that predicted correctly.         *)
(* 2. INTERFERENCE - two Bool3 signals meet: agree, disagree, or unknown.   *)
(* 3. VERDICT - a layer's list Bool3 becomes a collective decision          *)
(*    with honest confidence: how many agreed, how many were silent.        *)
(*                                                                          *)
(* Currently wired to LearningCell (void_learning_cell.v).                  *)
(* Interference and Verdict operate on Signal = list Bool3 and are          *)
(* cell-model independent. Refund and learn_from_truth use LearningCell     *)
(* directly — accumulator cells (void_predictive_cell.v) would need         *)
(* their own refund/learn wiring.                                           *)
(*                                                                          *)
(* DEPENDS ON: void_learning_cell, void_network                            *)
